# Contributing to cascadr

Thanks for your interest in cascadr — a cost-ordered, fail-open LLM provider cascade. It is one component of the
...
git clone https://github.com/Barnett-Studios/cascadr
cd cascadr
cargo build
```
...
cascadr is defined by its [`CONTRACT.md`](CONTRACT.md): the interface, the invariants, and the
...
[security advisory](https://github.com/Barnett-Studios/cascadr/security/advisories/new) form so it can be
fixed before disclosure.

---

Questions that don't fit an issue? Open a
[discussion](https://github.com/Barnett-Studios/cascadr/discussions). Thanks for contributing.
